...
export default function PdfViewer({ file }: Props) {
  ...
  return (
    <div className="rounded-2xl bg-white border border-neutral-200 overflow-hidden shadow-sm">
      <div className="overflow-x-auto overflow-y-auto p-4" style={{ WebkitOverflowScrolling: 'touch' }}>
        <Document
          file={file}
              ...
              >
                {visiblePages.has(i) ? (
                  ...
                  <div
                    ...
                    className="bg-neutral-100 rounded flex items-center justify-center text-neutral-400 text-sm"
                  >
                    Página {i + 1}
                  </div>
                )}
