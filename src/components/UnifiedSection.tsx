...
const TRANSITION_PHRASE = 'E custa menos do que você já perdeu tentando sozinha.'
      ...
      <div className="container-main max-w-xl relative">
        ...
        <div className="text-center mt-12 sm:mt-14 pt-2">
          ...
          <div className="mt-8 flex flex-col items-center gap-3" aria-hidden>
            <span className="block w-px h-8 bg-gray-200 rounded-full" />
            <svg className="w-5 h-5 text-rose-500" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
