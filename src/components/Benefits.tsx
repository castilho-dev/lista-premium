...
const items = [
  {
    ...
    desc: 'Nome, endereço, WhatsApp e Instagram de cada fornecedor testado pessoalmente. Tudo organizado para você acessar do celular.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    desc: 'Nossa equipe atualiza TODOS OS DIAS novos fornecedores com preços ainda menores. Oportunidades de lucro diárias no seu celular.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    desc: 'Ruby Rose, Mari Maria, Francine Elke, Bruna Tavares e muito mais. Compre direto de quem fabrica e revenda com lucro alto.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    desc: 'Receba no mesmo instante após a compra. Acesse do celular ou computador, tudo organizado e fácil de usar.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    desc: 'Se não gostar, devolvemos 100% do seu dinheiro. Sem perguntas, sem burocracia. Risco zero para você.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    desc: 'TODOS os fornecedores da lista aceitam compras sem CNPJ. Comece a revender mesmo sendo informal.',
  },
]
