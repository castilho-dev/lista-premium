...
const bonusItems = [
  {
    ...
    desc: 'Ferramenta inteligente para calcular preços de venda com base nos seus custos reais. Receba sugestões de preços, margem real e explicações detalhadas.',
  },
  {
    icon: (
    ...
    title: '10K com Instagram',
    desc: 'Aprenda a usar o Instagram para atrair clientes e vender maquiagem sem depender de anúncios pagos. Conteúdo, stories e DM que convertem em pedidos.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
    ...
    desc: 'Modelo de atendimento e catálogo no WhatsApp que vende enquanto você dorme. Mensagens que fecham venda e evitam perda de cliente.',
  },
]
  ...
  return (
    <section ref={ref} className="py-20 lg:py-28 bg-white section-padding">
      <div className="container-main">
        ...
        {/* 3 cards por linha no desktop; 1 ou 2 colunas no mobile/tablet */}
